                    ...
                    <div className="col-lg-8 col-md-8 col-sm-12">
                        <form method="" className="ayur-subscribe-sec">
                            ...
                            <div className="ayur-form-btn">
                                <a href="javascript:void(0)" className="ayur-btn">Subscribe</a>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6">
                        <div className="ayur-footer-logosec">
                            <div className="ayur-footer-logo">
                                <img src="/src/assets/images/logo/logo.png" style={{ width: "200px", height: "auto" }} alt="logo" />
                            </div>
                                ...
                                <li>
                                    <a href="javascript:void(0)">
                                        <svg width="11" height="20" viewbox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6.74157 20V10.8777H9.80231L10.2615 7.32156H6.74157V5.05147C6.74157 4.0222 7.02622 3.32076 8.50386 3.32076L10.3854 3.31999V0.13923C10.06 0.0969453 8.94308 0 7.64308 0C4.92848 0 3.07002 1.65697 3.07002 4.69927V7.32156H0V10.8777H3.07002V20H6.74157Z" fill="#E4D4CF"></path>
                                        </svg>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="javascript:void(0)">
                                        <svg width="21" height="20" viewbox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="M15.9172 5.83295C16.6075 5.83295 17.1672 5.27332 17.1672 4.58298C17.1672 3.89264 16.6075 3.33301 15.9172 3.33301C15.2269 3.33301 14.6672 3.89264 14.6672 4.58298C14.6672 5.27332 15.2269 5.83295 15.9172 5.83295Z" fill="#E4D4CF"></path>
                                            <path d="M10.4999 5C7.73793 5 5.5 7.23818 5.5 9.99988C5.5 12.7606 7.73793 15.0002 10.4999 15.0002C13.261 15.0002 15.4998 12.7606 15.4998 9.99988C15.4998 7.23818 13.261 5 10.4999 5ZM10.4999 13.3335C8.65915 13.3335 7.16671 11.8411 7.16671 9.99988C7.16671 8.15866 8.65915 6.66671 10.4999 6.66671C12.3406 6.66671 13.833 8.15866 13.833 9.99988C13.833 11.8411 12.3406 13.3335 10.4999 13.3335Z" fill="#E4D4CF"></path>
                                        </svg>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div className="ayur-footer-box">
                            ...
                            <ul className="ayur-contact-list">
                                <li className="ayur-contact-box">
                                    <img src="/src/assets/images/location.png" alt="icon" />
                                    <p>4517 Washington Ave. <br /> Manchester, Kentucky 39495</p>
                                </li>
                                <li className="ayur-contact-box">
                                    <img src="/src/assets/images/mobile.png" alt="icon" />
                                    <p>(208) 555-0112</p>
                                </li>
                                <li className="ayur-contact-box">
                                    <img src="/src/assets/images/email.png" alt="icon" />
                                    <p><a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="b8ddc0d9d5c8d4ddf8dfd5d9d1d496dbd7d5">[email&#160;protected]</a></p>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <ul className="ayur-recent-blog">
                                <li className="ayur-recentblog-box">
                                    <div className="ayur-recentblog-boximg">
                                        <img src="/src/assets/images/footer-blog1.png" alt="image" />
                                    </div>
                                    <div className="ayur-recentblog-text">
                                        <p className="date">Jun 10,2024</p>
                                        <h3 className="text">Amet minim mollit non deserunt est sit Velit officia consequat.
                                        </h3>
                                    </div>
                                </li>
                                <li className="ayur-recentblog-box">
                                    <div className="ayur-recentblog-boximg">
                                        <img src="/src/assets/images/footer-blog2.png" alt="image" />
                                    </div>
                                    <div className="ayur-recentblog-text">
                                        <p className="date">Jun 10,2024</p>
                                        <h3 className="text">Amet minim mollit non deserunt est sit Velit officia consequat.
            ...
            <div className="row">
                <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div className="ayur-copyright-para">
                        <p>Copyright © 2025. All Right Reserved. Mai Sanatani Develop by Digital Darzee</p>
                    </div>
                </div>
            </div>
        </div>
        <div className="ayur-bgshape ayur-footer-bgshape">
            <img src="/src/assets/images/footer-left.png" alt="img" />
            <img src="/src/assets/images/footer-right.png" alt="img" />
        </div>
    </div>
  );
};
