                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="ayur-tpro-box ayur-trepro-box">
                                <div className="ayur-tpro-img">
                                    <img src="/src/assets/images/Bottels/Giloy.png" alt="img" />
                                    <div className="ayur-tpro-sale">
                                        <p>Sale</p>
                                        <div className="ayur-tpro-like">
                                            <a href="javascript:void(0)" className="ayur-tpor-click">
                                ...
                                <div className="ayur-tpro-text">
                                    <h3><a href="shop-single.html">Giloy</a></h3>
                                    <div className="ayur-tpro-price">
                                        <p><del>$100</del>$50</p>
                                        <div className="ayur-tpro-star">
                                            <img src="/src/assets/images/star-icon.png" alt="star" />
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="ayur-tpro-box ayur-trepro-box">
                                <div className="ayur-tpro-img">
                                    <img src="/src/assets/images/Bottels/Grape.png" alt="img" />
                                ...
                                <div className="ayur-tpro-text">
                                    <h3><a href="shop-single.html">Grape</a></h3>
                                    <div className="ayur-tpro-price">
                                        <p><del>$100</del>$50</p>
                                        <div className="ayur-tpro-star">
                                            <img src="/src/assets/images/star-icon.png" alt="star" />
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="ayur-tpro-box ayur-trepro-box">
                                <div className="ayur-tpro-img">
                                    <img src="/src/assets/images/Bottels/Green coffee.png" alt="img" />
                                ...
                                <div className="ayur-tpro-text">
                                    <h3><a href="shop-single.html">Green Coffee</a></h3>
                                    <div className="ayur-tpro-price">
                                        <p><del>$100</del>$50</p>
                                        <div className="ayur-tpro-star">
                                            <img src="/src/assets/images/star-icon.png" alt="star" />
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="ayur-tpro-box ayur-trepro-box">
                                <div className="ayur-tpro-img">
                                    <img src="/src/assets/images/Bottels/Green tea.png" alt="img" />
                                    <div className="ayur-tpro-sale ayur-tpro-sale-star">
                                        <div className="ayur-tpro-like">
                                            <a href="javascript:void(0)" className="ayur-tpor-click">
                                                <img src="/src/assets/images/like.svg" className="unlike" />
